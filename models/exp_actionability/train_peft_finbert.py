...
def parse_args() -> argparse.Namespace:
    ...
    default_output_dir = project_dir / 'models' / 'artifacts' / 'finbert_actionability_peft'

    parser = argparse.ArgumentParser(description='Train LoRA/PEFT FinBERT on FiQA actionability labels.')
    parser.add_argument('--train-path', type=Path, default=default_data_dir / 'actionability_train.csv')
    parser.add_argument('--val-path', type=Path, default=default_data_dir / 'actionability_val.csv')
...
def main() -> None:
    ...
    print(f'Saved PEFT model and tokenizer to: {output_dir}')
