...
def parse_args() -> argparse.Namespace:
    ...
    default_output_dir = project_dir / 'models' / 'artifacts' / 'finbert_actionability'

    parser = argparse.ArgumentParser(description='Fine-tune FinBERT on FiQA actionability labels.')
