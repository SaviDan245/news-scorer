...
def parse_args() -> argparse.Namespace:
    ...
    default_output_dir = project_dir / "models" / "artifacts" / "finbert_phrasebank"

    parser = argparse.ArgumentParser(description="Fine-tune FinBERT on Financial PhraseBank.")
    
    parser.add_argument("--train-path", type=Path, default=default_data_dir / "train.csv")
    parser.add_argument("--val-path", type=Path, default=default_data_dir / "val.csv")
